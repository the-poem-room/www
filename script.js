...
const poems = [
  ...
  },
  {
    title: "SADBOY",
    lines: [
      { text: "Eva, can I see bees in a cave?", className: "poem-stanza--centered poem-stanza--sadboy-1" },
      { text: "Madam, in Eden, I’m Adam.", className: "poem-stanza--centered poem-stanza--sadboy-2" },
      { text: "Step on no pets.", className: "poem-stanza--centered poem-stanza--sadboy-3" },
      { text: "A Santa lived as a devil at NASA.", className: "poem-stanza--centered poem-stanza--sadboy-4" },
      { text: "No lemon, no melon.", className: "poem-stanza--centered poem-stanza--sadboy-5" },
      { text: "Was it a car or a cat I saw?", className: "poem-stanza--centered poem-stanza--sadboy-6" },
      { text: "Never odd or even.", className: "poem-stanza--centered poem-stanza--sadboy-7" },
      { text: "Yo, Banana Boy!", className: "poem-stanza--centered poem-stanza--sadboy-8" },
      { text: "Mr. Owl ate my metal worm.", className: "poem-stanza--centered poem-stanza--sadboy-9" },
      { text: "Go hang a salami, I’m a lasagna hog.", className: "poem-stanza--centered poem-stanza--sadboy-10" },
      "— Lilith",
    ],
  },
