...
function poemPageTemplate(poem, previousPoem, nextPoem) {
  ...
  return `<!doctype html>
<html lang="en" data-theme="dark" data-line-numbers="hide" data-mini-map="show">
  <head>
    <meta charset="utf-8">
        ...
        <div class="settings-panel" id="settings-panel" data-settings-panel hidden>
          ...
          <div class="settings-row settings-row-stacked">
            ...
            <div class="mini-map-control" role="group" aria-label="Mini map">
              <button type="button" data-mini-map-option="show" aria-pressed="true">Show</button>
              <button type="button" data-mini-map-option="hide" aria-pressed="false">Hide</button>
            </div>
          </div>
        </div>
      </div>
